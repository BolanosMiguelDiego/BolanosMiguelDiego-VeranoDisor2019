...
NumeroDeUlam.prototype.avanzar = function()
{
    ...
    document.getElementById("decimal2").innerHTML = this.numeroActual;
    document.getElementById("binario2").innerHTML = this.binario();
    document.getElementById("hexadecimal2").innerHTML = this.hexadecimal();
    document.getElementById("capicua2").innerHTML = this.capicua();
    document.getElementById("feliz2").innerHTML = this.soyFeliz();
};
